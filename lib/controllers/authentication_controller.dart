...
class AuthenticationController extends GetxController
{
  ...
  Future<String> uploadImageToStorage(File imageFile) async
  {
    Reference referenceStorage = FirebaseStorage.instance.ref()
        .child("Profile Image").child(FirebaseAuth.instance.currentUser!.uid);
...

  {
    try
    {
      ...
      Get.snackbar("Account created","Congratulations!,your account has been created successfully");;
      Get.to(HomeScreen());
    }
    catch(errorMsg)
    {
      Get.snackbar("Account creation successful","Error occurred: $errorMsg");
    }
  }
  ...
  loginUser(String emailUser, String passwordUser) async
  {
    try
    {
      ...
      Get.snackbar("Logged in successfully", "you're logged in to your account");
  ...
  checkedIfUserIsLoggedIn(User? currentUser)
  {
    if(currentUser == null)
    {
      Get.to(LoginScreen());
  ...
  void onReady() {
    ...
    ever(firebaseCurrentUser, checkedIfUserIsLoggedIn);
  }
}
